    ...
    function( carousel ) {
        ...
        Loop.prototype = {
                ...
                self.api.subscribe(
                    ...
                    function() {
                        ...
                        if ( pluginOn ) {
                            ...
                            // Init functionality only if there are more carousel tiles than tilesPerFrame
                            if ( self.carousel.tileArr.length >  self.carousel.tilesPerFrame ) {

                                if ( !self.pluginInited ) {

                                    self.origTileDom = self.carousel.tileArr;
                                    ...
                                    // Plugin subscribers
                                    self.api.subscribe(
                                        pageNS + '/buildPagination/before',
                                        self.loadPagination.bind( self )
                                    );

                                    self.api.subscribe(
                                        pageNS + '/updatePagination/before',
            ...
            createLoopDom: function() {
                ...
                var clones = [];
                var tileHTMLColl = this.origTileDom;
            ...
            loadPagination: function() {
                ...
                this.api.trigger( 'cache', pageNS + '/paginationArr', this.paginationArr );
            },
            ...
            updatePagination: function() {
                ...
                this.api.trigger( 'cache', pageNS + '/newFrameIndex', updateVal );
            }
        };
