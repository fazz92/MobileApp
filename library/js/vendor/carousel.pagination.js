define(
    ...
    function( carousel ) {
        ...
        var tmplPagination = doc.createElement( 'ul' )
            ...
            , tmplFrameLink = '<li id="{crsl}-pg-{number}"><a class="carousel-frame" data-frame="{number}" title="{current}">{frameText}</a></li>'
            ;
        ...
        Pagination.prototype = {
            ...
            buildPagination: function( controls, btnPrev, btnNext ) {
                ...
                this.api.publish( pluginNS + '/buildPagination/before' );

                var paginationArr = this.api.trigger( 'cache', pluginNS + '/paginationArr' );
                ...
                this.api.publish( pluginNS + '/buildPagination/after' );
            },
            ...
            updatePagination: function() {
                ...
                this.api.publish( pluginNS + '/updatePagination/before' );

                var pageLink, linkClass, loopLength;
                var newFrame = [];
                var newFrameIndex = this.api.trigger( 'cache', pluginNS + '/newFrameIndex' );
                ...
                if ( newFrame && newFrame.length > 0 ) {
                    ...
                    //Carousel Redesign for MGPT-6518
                    if( !this.options.multipleHighlight ){
                        newFrame[0].className += selected;
                    }
                ...
                this.api.publish( pluginNS + '/updatePagination/after' );
            }
        };
